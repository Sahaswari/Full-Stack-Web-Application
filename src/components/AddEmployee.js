  ...
  return (
    <div className='flex max-w-2xl mx-auto shadow boarder-b'>
      <div className='px-8 py-8'>
        ...
        <button onClick={saveEmployee} className='rounded text-white font-semibold bg-blue-800 py-2 px-6 hover:bg-blue-500'>Save</button>
        <button className='rounded text-white font-semibold bg-red-800 py-2 px-6 hover:bg-red-500'>Clear</button>
        </div>
      </div>
